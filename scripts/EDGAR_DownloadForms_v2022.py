...
PARM_FORMS = MOD_EDGAR_Forms.f_10K  # or, for example, PARM_FORMS = ['8-K', '8-K/A']
...
PARM_PATH = r'd:/my files_/GIT/Job Applications/Mentorcruise/Tunyi/data/'
# Change the file pointer below to reflect your location for the log file
#    (directory must already exist)
PARM_LOGFILE = (r'd:/my files_/GIT/Job Applications/Mentorcruise/Tunyi/data/EDGAR_Download_FORM-X_LogFile_' +
