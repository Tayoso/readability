...
TARGET_FILES = r'd:\my files_\GIT\Job Applications\Mentorcruise\Tunyi\data\1994\QTR3\*.*'
# User defined file pointer to LM dictionary
MASTER_DICTIONARY_FILE = r'd:\my files_\GIT\Job Applications\Mentorcruise\Tunyi\data\Loughran-McDonald_MasterDictionary_1993-2021.csv'
# User defined output file
OUTPUT_FILE = r'd:\my files_\GIT\Job Applications\Mentorcruise\Tunyi\data\Parser.csv'
# Setup output
